...
#           evict-on: M
#         """)
#         traces = {("A", "M", "payload", "read"): "tmp/test_traffic_stage0-M-iter.csv"}
#
...
#
#         traces = {
#             ("A", "M", "payload", "read"): "tmp/test_traffic_stage0-M-iter.csv",
#             ("A", "K", "coord", "read"): "tmp/test_buffetTraffic_multiple_bindings-K_coord.csv",
...
#
#         traces = {
#             ("A", "K", "payload", "read"): "tmp/test_buffetTraffic_multiple_tensors.csv",
#             ("B", "K", "payload", "read"): "tmp/test_buffetTraffic_multiple_tensors.csv"
#         }
#
